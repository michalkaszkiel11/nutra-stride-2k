          ...
          <div className={styles.mealTypes}>
            {mealTypes.map((mealType) => (
              <button
                key={mealType}
                className={
                  selectedMealType === mealType ? styles.activeTab : ""
                }
          ...
          <div className={styles.rightContent}>
            ...
            {selectedMeal && (
              <div className={styles.selectedMealContent}>
                ...
                />
                <h3 className={styles.cardTitle}>{selectedMeal.title}</h3>
                <p className={styles.cardContent}>{selectedMeal.content}</p>
                <span>Health Impact Range: {selectedMeal.healthImpactRange}</span>
              </div>
            )}
          </div>
        </div>
